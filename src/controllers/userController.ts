...
export class UserController {
  ...
  static async checkUsername(request: FastifyRequest<{ Querystring: { username: string } }>, reply: FastifyReply) {
    try {
  ...
  static async checkEmail(request: FastifyRequest<{ Querystring: { email: string } }>, reply: FastifyReply) {
    try {
